...
"""
start = int(input("Введите результат километров в первый день >>>"))
goal = int(input("Введите требуемый результат спортсмена в километрах >>>"))
...
while start < goal:
    ...
    print("На ", day, "день спортсмен достиг результата — не менее", goal, " км.")
